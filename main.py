...
def main():
    ...
    parser.add_argument('-d', '--distribution', type=str, 
                        choices=['LabelSkew_c1', 'LabelSkew_c2', 'IID', 'QuantitySkew'], default='LabelSkew_c2',
                        help='Data distribution type: LabelSkew_c1 (1 class per client), LabelSkew_c2 (2 classes per client), IID (randomly distributed), or QuantitySkew (quantity skew)')
